...
SYSTEM_PROMPT = (
    "You triage GitHub issues for the agent-radar project, an Activation Gap "
    "diagnostic for Claude Code setups. Decide if each issue is worth opening a PR for. "
